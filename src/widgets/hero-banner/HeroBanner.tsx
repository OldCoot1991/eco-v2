        ...
        slides: [
            {
                ...
                description: "Профессиональный вывоз мусора в Нальчике и Кабардино-Балкарской Республике",
            ...
            },
            {
                ...
                description: "Современные технологии обращения с отходами для комфортной жизни",
        ...
        slides: [
            {
                ...
                description: "Professional waste collection in Nalchik and Kabardino-Balkarian Republic",
            ...
            },
            {
                ...
                description: "Modern waste management technologies for comfortable living",
...
export const HeroBanner = () => {
    ...
    const slides = translations[currentLanguage as keyof typeof translations].slides;
