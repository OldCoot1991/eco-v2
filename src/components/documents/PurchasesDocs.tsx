...
const documentPaths = [
    ...
    "/docs/purchases/order286.pdf",               // 1
    "/docs/purchases/listOfServicesAndGoods.pdf", // 2
];

export default function PurchasesDocs() {
                    ...
                    {documentPaths.map((href, index) => (
                        <div key={index} className={styles.card}>
                            <div className={styles.cardContent}>
                                ...
                                <h3 className={styles.cardTitle}>{t.documents.purchases.list[index] || ""}</h3>
                            </div>
