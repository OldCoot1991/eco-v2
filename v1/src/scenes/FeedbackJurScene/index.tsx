...
import styles from './feedbackjurscence.module.css'
import EcoMobileAppBanner from '../../components/EcoMobileAppBanner';

// Бизнесу: Обратная связь
function FeedbackJurScene() {
        ...
        <>
            <div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input onChange={(e) => setState({ ...state, organizationName: e.target.value })} className={styles.input} placeholder="Наименование организации*" required />
                    <NumberFormat
...
export default FeedbackJurScene;
